...
public class Banco {
  ...
  public Banco(String nome, Long cnpj, int numeroDaConta, double saldo, boolean statusDaConta, String tipoDaConta) {
    ...
    public void criacaoConta() {
        ...
        System.out.println("Qual é o tipo de conta que voce quer usar mano");
        String inputCPorCC = scannerQuestion.nextLine();
        if (inputCPorCC.equals("CP")) {
            setTipoDaConta("CP");
            System.out.println("Seu tipo de conta é: " + getTipoDaConta());
        } else if (inputCPorCC.equals("CC")) {
            setTipoDaConta("CC");
            System.out.println("Seu tipo de conta é: " + getTipoDaConta());
        }
